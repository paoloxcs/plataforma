...
@section('content')
    <div class="container">
            ...
            <div class="panel-body">
                {{-- <div class="col-xs-12 col-md-6">
                        <div class="input-group has-success">
                            ...
                            <input type="text" class="form-control" onkeyup="buscar(this);"
                                aria-describedby="basic-addon3" placeholder="Escriba aquí y presione enter">
                        </div>
                    </div> --}}
                {{-- Filtrar por fecha Filtrar por estado --}}
                <div class="row">
                    <form action="{{ route('video.index') }}" class="col-xs-12 col-md-8">
                        @if (request('order'))
                            <input type="hidden" name="order" value="{{ request('order') }}">
                        @endif
                        @if (request('r'))
                            <input type="hidden" name="rubro" value="{{ request('rubro') }}">
                        @endif
                    ...
                    <div class=" col-xs-12 col-md-4" style="display: flex; flex-direction: column;">
                        <div style="display: flex">
                            <span onclick="openNewModalFilter();" class="btn btn-warning"
                                ...
                                Filtros</span>
                            <a href="{{ route('video.index') }}" class="btn btn-danger" title="Eliminar filtros"
                                style="margin-top: 1rem"> <i class="fa fa-trash" aria-hidden="true"></i> </a>
                        </div>
                        <a onclick="createVideo();" class="btn btn-success pull-right" style="margin-top: 2rem"><i
                                class="fa fa-plus" aria-hidden="true"></i> Nuevo registro</a>
                    </div>

                    {{-- <div class="col-xs-12 col-md-6">
                        <button onclick="createVideo();" class="btn btn-success pull-right"><i class="fa fa-plus"
                        ...
                        <tbody>
                            @forelse ($videos as $video)
                                <tr>
                                    ...
                                    @php
                                        $date = new DateTime($video->post->fecha);
                                    @endphp
                ...
                <div class="row">
                    <div class="col-xs-12 col-md-8">
                        <div class="input-group custom-pagination">
                            ...
                            {{ $videos->appends(['search' => request('search'), 'order' => request('order'), 'sub_c' => request('sub_c'), 'r' => request('r'), 'count_video' => $videos_count])->render() }}
                        </div>
                    </div>
        ...
        @include('panel.video.new_filters')
    </div>
