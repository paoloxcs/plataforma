    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="modal-title"><h4>Aplicar filtros</h4></div>
          ...
          <form onsubmit="applyFilterRecurrente();" method="POST" id="form_filter" action="#">
				...
				<div class="row">
					...
					<div class="col-xs-12 col-md-4">
						<div class="panel panel-success">
							<div class="panel-heading">
								<div class="panel-title">Por metodo de pago</div>
							</div>
					...
					{{-- <div class="col-xs-12 col-md-4">
						<div class="panel panel-warning">
							...
							<div class="panel-body">
								<div class="radio">
								  <label>
								    <input type="radio" name="status" id="estadox" value="0" checked>
								   	Ambos
								  </label>
								</div>
								<div class="radio">
								...
								<div class="radio">
								  <label>
								    <input type="radio" name="status" id="estado2" value="2">
								    Expirado
								  </label>
								</div>
							</div>
