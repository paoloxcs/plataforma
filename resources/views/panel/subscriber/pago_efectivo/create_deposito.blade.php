...
<!-- Small modal -->
<div class="modal" id="modal_edit_premium" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          <div class="modal-title"><h4>Crear suscripción </h4></div>
          </div>
            <form onsubmit="saveSubscriberPremium(this);" method="POST" action="#" id="editformPremium">
                          ...
                          <div class="row">
                              <div class="col-xs-12 col-md-6">
                                  <div class="form-group">
                                      ...
                                      <input type="hidden" name="suscriptor_efectivo_id">
