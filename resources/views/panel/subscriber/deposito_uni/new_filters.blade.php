                ...
                <div class="modal-body">
                    <div class="card-columns" style="   ">
                            ...
                            <div class="panel panel-success">
                                ...
                                <div class="panel-body">
                                    @foreach ($asesores as $asesor)
                                        <div class="radio">
                                            <label>
                                                <input type="radio" name="asesor"
                                                    @if (request('asesor') == $asesor->id) checked @endif
                                                    value="{{ $asesor->id }}">
                        ...
                        <div class="card" style="">
                            <div class="panel panel-success">
                                <div class="panel-heading">
                                    <div class="panel-title">Filtrar por fechas:</div>
                                </div>
                                <div class="panel-body">
                                    <div class="form-group">
                                        <label for="fecha_start">Fecha de Inicio:</label>
                                        <input class="form-control" id="fecha_start" name="fecha_start"
                                            placeholder="AA/MM/DD"
                                            value="{{ old('fecha_start', request('fecha_start')) }}"
                                            type="date" />
                                    </div>

                                    <div class="form-group">
                                        <label for="fecha_end">Fecha de Fin:</label>
                                        <input class="form-control" id="fecha_end" name="fecha_end"
                                            placeholder="AA/MM/DD"
                                            value="{{ old('fecha_end', request('fecha_end')) }}"
                                            type="date" />
                                    </div>
