    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="modal-title"><h4><i class="fa fa-pencil"></i> Editar registro</h4></div>
          ...
          <form onsubmit="updateSerie(this)" method="POST" action="#" id="form-edit" enctype="multipart/form-data">
            {{ csrf_field() }}
            {{ method_field('PUT') }}
              ...
              <div class="row">
                <div class="col-xs-12 col-md-8">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="titulo" placeholder="Ingrese Título al serie">
                     </div>
                     <div class="form-group">
