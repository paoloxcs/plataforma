                                ...
                                <div class="text" style="padding: 0">
                                    ...
                                    <div class="col-md-12 row pbm-0 mt-3">
                                        ...
                                        <div class="col-md-8 pbm-0 mx-auto">
                                            <p>
                                                <a class="nav-link a-menu nav-a-class text-center" href="{{ $url }}">INGRESAR A CURSO</a>
                                            </p>

                                            <!-- 13DIC CAMBIO ACCESO BOTÓN MATERIAL - CURSO POR INICIAR -->
                                            <p>
                                                <a class="nav-link a-menu nav-a-class text-center" href="{{ route('getclase', $clase->slug) }}">VER MATERIAL</a>
                                            </p>
                                            <!-- 13DIC CAMBIO ACCESO BOTÓN MATERIAL - CURSO POR INICIAR -->
                            ...
                            <div class="text" style="padding: 0">
                                ...
                                <div class="col-md-12 row pbm-0 mt-3">
                                    ...
                                    <div class="col-md-8 pbm-0 mx-auto">
                                        ...
                                        <p>
                                            <a class="nav-link a-menu nav-a-class text-center" href="{{ route('getclase', $clase1->slug) }}">INGRESAR A CURSO</a>
                                        </p>

                                        <!-- 13DIC CAMBIO ACCESO BOTÓN MATERIAL - CURSO POR INICIAR -->
                                        <p>
                                            <a class="nav-link a-menu nav-a-class text-center" href="{{ route('getclase', $clase1->slug) }}">VER MATERIAL</a>
                                        </p>
                                        <!-- 13DIC CAMBIO ACCESO BOTÓN MATERIAL - CURSO POR INICIAR -->
                                    ...
                                    <div class="text" style="padding: 0">
                                        ...
                                        <div class="col-md-12 row pbm-0 mt-3">
                                            ...
                                            <div class="col-md-8 pbm-0 mx-auto">
                                                ...
                                                <!-- 13DIC CAMBIO ACCESO BOTÓN MATERIAL - CURSO INICIADO -->
                                                <p><a class="nav-link a-menu text-center a-transparent-g"
                                                        href="{{ route('getclase', $clase->slug) }}">
                                                        VER MATERIAL
                                                    </a>
                                                </p>
                                                <!-- 13DIC CAMBIO ACCESO BOTÓN MATERIAL - CURSO INICIADO -->
