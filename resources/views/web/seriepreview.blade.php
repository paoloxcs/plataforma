  ...
  <section class="col-md-10 mx-auto row pbm-0">
    ...
    <section class="col-md-8 col-xs-12">
      <div class="d-title">
        ...
        <p class="p-inline p-c-i p-m-l"><i class="fas fa-clock"></i> {{$post->serie->duracion}}</p>
      ...
      <div class="col-md-12">
       ...
       <iframe src="https://player.vimeo.com/video/{{$post->serie->url_preview}}" class="embed-responsive-item" frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>
                  ...
                  <section class="col-md-12 pbm-0 s-login" style="  padding:  1% 3%"  >
                      ...
                      <div class="col-md-12 row">
                        ...
                        <div class="col-md-10 pbm-0">
                          ...
                          @else
                          <p class=" mt-3"><a class="a-menu a-menu-b" style="text-decoration: none" href="{{url('/login?redirect_to='.route('getserie',$post->slug))}}">RESPONDER</a> </p>      
                          @endif
                        </div>    
                      </div>   
              ...
              <form>
                 ...
                 <p class="mt-2 font-weight">¿Recomiendas este curso? &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                  ...
                  @else
                      ...
                      <span class="s-coment" style="cursor:pointer"><a href="{{url('/login?redirect_to='.route('getserie',$post->slug))}}"><i class="fas fa-thumbs-up"></i> SI</a></span>
                      <span class="s-coment" style="cursor:pointer"><a href="{{url('/login?redirect_to='.route('getserie',$post->slug))}}"><i class="fas fa-thumbs-down"></i> NO</a></span></p>         
                  @endif
                ...
                @else
                     <a class="a-menu a-menu-b" style="text-decoration: none;cursor:pointer" href="{{url('/login?redirect_to='.route('getserie',$post->slug))}}">COMENTAR</a>         
                @endif
              </form>
