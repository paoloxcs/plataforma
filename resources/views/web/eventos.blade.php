...
@section('content')
  <section class="col-md-12 bg-gris pbm-0 s-cursos"> 
    ...
    <section class="col-md-10 mx-auto row pbm-0 mt-5">
      <h5 class="title-c pbm-0">EVENTOS</h5>
    </section>
    ...
    <div class="d-flex align-items-start col-md-10 mx-auto row">
      <div class="nav flex-column nav-pills  col-md-2 mt-1" id="v-pills-tab" role="tablist" aria-orientation="vertical">
        ...
        <br>
        <button class="nav-link btn-left active" id="v-pills-home-tab" data-bs-toggle="pill" data-bs-target="#v-pills-home" type="button" role="tab" aria-controls="v-pills-home" aria-selected="true">Eventos disponibles</button>
      ...
      <div class="tab-content col-md-10 mt-1" id="v-pills-tabContent">
        <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
          ...
          <h5 class="font-weight p-inline">EVENTOS DISPONIBLES</h5>
          ...
          <div class="col-md-12 row mt-2">
            ...
            <section class="col-md-4 card-curso card-curso-p">
              <div class="img">
                <a href=""><img src="{{asset('images/s-evento.jpg')}}" width="100%"></a>
                
              </div>
              <div class="text">
              	<p class="text-center mt-2"><span class="s-clock"><i class="fas fa-calendar-alt"></i> 00/00/00</span></p>
                <h4 class="title font-weight">Tecnologías y Actuales soluciones en: Encofrados y Andamios para la Construcción</h4>
              </div>
