    ...
    <div class="modal-content">
      <div class="modal-header">
		<div class="d-flex w-100"> 
			...
			<button type="button" onclick="closeFilterExecute();" style="margin-left:auto" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
		</div>
        </div>
