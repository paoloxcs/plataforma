  ...
  <section class="col-md-10 mx-auto row pbm-0">
    ...
    <section class="col-md-8 col-xs-12">
      ...
      <div class="none">{{$class=0}}</div>
       ...
       @foreach($clases as $clase)
        ...
        @if($clase->zoom_codigo_url!="" and $clase->video_codigo=="")
          ...
          <section class="card-curso mt-5-mob" style="padding-bottom: 0px!important;">

              <div class="img">

                <a href="{{$url}}"><img src="{{asset('imgCurso/'.$clase->url_portada)}}" width="100%"></a>

                <span><a href="{{$url}}" class="a-icon"><i class="fas fa-play-circle"></i></a></span>
              ...
              <div class="text" style="padding: 0">
                ...
                <a  class="td-none" href="{{$url}}"><h5 class="mt-3 font-weight">{{$clase->titulo}}</h5></a>

                <a class="td-none"  href="{{route('getAutor',$curso->autor->slug)}}"><p class="font-weight">{{$curso->autor->nombre}}</p></a>
                ...
                <div class="col-md-12 row pbm-0 mt-3">
                  ...
                  <div class="col-md-8 pbm-0 mx-auto">
                    ...
                    <p><a class="nav-link a-menu a-menu-c text-center" href="{{$url}}">INGRESAR A CURSO</a></p>                  
       ...
       @if($class<1)
        ...
        <section class="card-curso mt-5-mob" style="padding-bottom: 0px!important;;">
              ...
              <div class="img">
                ...
                <a href="{{route('getclase',$clase1->slug)}}"><img src="{{asset('imgCurso/'.$clase->url_portada)}}" width="100%"></a>

                <span><a href="{{route('getclase',$clase1->slug)}}" class="a-icon"><i class="fas fa-play-circle"></i></a></span>
              ...
              <div class="text" style="padding: 0">
                ...
                <a class="td-none" href="{{route('getclase',$clase1->slug)}}"><h5 class="mt-3 font-weight">{{$clase1->titulo}}</h5></a>
                ...
                <div class="col-md-12 row pbm-0 mt-3">
                  ...
                  <div class="col-md-8 pbm-0 mx-auto">
                    ...
                    <p><a class="nav-link a-menu a-menu-c text-center" href="{{route('getclase',$clase1->slug)}}">INGRESAR A CURSO</a></p>
      ...
      <div class="descripción mt-4 mt0-mob">
       ...
       <h4 class="font-weight c-green">Descripción</h4>
            ...
            <div class="accordion-item">
              ...
              <div id="{{'flush-collapse'.$clase->id}}" class="{{'accordion-collapse collapse '.$show}}" aria-labelledby="{{'flush-heading'.$clase->id}}" data-bs-parent="#accordionFlushExample">
                ...
                <div class="accordion-body">
                  ...
                  <p class="text-center mt-4"><a href="{{route('getclase',$clase->slug)}}" class="a-transparent-g" href=""><i class="fas fa-eye"></i> VER MATERIAL</a></p>
            ...
            <div class="col-md-11 pbm-0">
              ...
              <form>
                 ...
                 <p class="mt-2 font-weight">¿Recomiendas este curso? &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                    ...
                    <span class="s-coment" style="cursor:pointer"><a type="button" onclick="saveLike({{$curso->id}});"><i class="fas fa-thumbs-up"></i> SI</a></span>

                    <span class="s-coment" style="cursor:pointer"><a type="button" onclick="saveNotLike({{$curso->id}});"><i class="fas fa-thumbs-down"></i> NO</a></span></p>
      ...
      <div class="none">{{$class=0}}</div>
       ...
       @foreach($clases as $clase)
        ...
        @if($clase->zoom_codigo_url!="" and $clase->video_codigo=="")
          ...
          <section class="card-curso mt-5-mob">
              ...
              <div class="text" style="padding: 0">
                ...
                <div class="col-md-12 row pbm-0 mt-3">
                  ...
                  <div class="col-md-8 pbm-0 mx-auto">
                     ...
                     {{--<p><a class="nav-link a-menu a-menu-c text-center" href="{{$url}}">INGRESAR A CURSO</a></p>--}}
                    <p>
                      <a class="nav-link a-menu text-center nav-a-cursos"
                            href="{{ $url }}">  
                           INGRESAR A CURSO 
                        </a>
                    </p>                  
