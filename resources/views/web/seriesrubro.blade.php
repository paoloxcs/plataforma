      ...
      <section class="col-md-3 col-xs-12">
        ...
        <ul class="ul-left mt-5 mt-2-mob">
          ...
          @foreach($categorias as $cat)
            <li class="">
              <a href="{{route('serieCat',$cat->slug)}}" class="" style="width: 80%;position: relative;display: inline-block">{{$cat->nombrecategoria}}</a>
              <span class="badge badge-secondary float-right" style="background: #24db37;float:right;margin-top: 1%">{{$cat->countSeries()}}</span>
            </li>
          @endforeach
        </ul>
