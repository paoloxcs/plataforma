		...
		<div class="card">
			<div class="card-header">
				<div class="row">
					...
					<div class="col-md-10">
						<H4 class="plan-pay-name">Renovación: {{$plan->name}}</H4>
				...
				<div class="row">
					<div class="col-xs-12 col-md-6">
					  	...
					  	<div class="tab-content" id="myTabContent">
					  	  <div class="tab-pane fade show active mt-4 text-center" id="online" role="tabpanel" aria-labelledby="online-tab">
					  	  	
				  			   <button type="button" id="buyButton1" class="btn btn-green btn-lg">PAGAR S/. {{$plan->precio}}</button>


			  			      <section class="pasarela">
			  			        <h2>Pague aquí con:</h2>
					...
					<div class="col-xs-12 col-md-6">
						<div class="row">
	  			        ...
	  			        <div class="col-md-8 datasuscriptioninfo">
	  			          <h2>Capacitación en línea</h2>
	  			          <p>Utiliza nuestros vídeos de capacitación online para ampliar tus conocimientos.</p>
	  			        </div>
  			      		</div>
			...
			<div class="card-body">
				<div class="row">
					...
					<div class="col-xs-12 col-md-6">
						...
						<div class="row">
	  			        <div class="col-md-2 datasuscriptionicon text-center">
	  			          {{--<i class="suscriptionicono fas fa-play-circle"></i> --}}
	  			        </div>
	  			        <div class="col-md-10 datasuscriptioninfo">
	  			          <h2 style="color:black;font-weight: 700">Accede a todo el catálogo con una Membresía Premium</h2>
	  			          <li style="list-style:none"><i style="font-size: 20px;color:green" class="fas fa-video"></i> Obtén acceso ilimitado a vídeos de capacitaciones en construcción, arquitectura y minería.</li>   
	  			          <li style="list-style:none"><i style="font-size: 20px;color:green" class="far fa-file-image"></i> Acceso y/o descarga de cientos de revistas especializadas en construcción, arquitectura y minería.</li>
	  			          <li style="list-style:none"><i style="font-size: 20px;color:green" class="fas fa-hand-holding-usd"></i> Descuentos en seminarios y cursos online en vivo con certificación, organizados por nosotros.</li>
	  			          <li style="list-style:none"><i style="font-size: 20px;color:green" class="far fa-calendar-times"></i> Válida por {{$plan->meses}} meses, autorenovable por pago con tarjeta de crédito.</li>
	  			        ...
	  			        <div class="col-md-10 datasuscriptioninfo">
	  			          {{--<h2 style="color:black;font-weight: 700">Suplemento Técnico</h2>
	  			          <p><i style="font-size: 20px;color:green" class="fas fa-file-alt"></i> Encuentra costos y presupuestos de obras, análisis de precios unitarios, precios actualizados de materiales y mucho más.</p>
--}}

	  			          <p style="font-size:13px;color:#8AA3FF">1) Acepto expresamente todos los Términos y Condiciones de Membresías Premium.  Del mismo, modo acepto las Políticas y Avisos de Protección y Tratamiento de Datos Personales de Plataforma Constructivo.</p>
	  			        </div>
  			      		</div>
					</div>
				</div>
