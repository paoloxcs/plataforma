...
class SuscriptorRecurrente extends Model
{
    protected $table ='suscriptores_recurrente';
    protected $fillable =['user_id','plan_id','suscription_init','suscription_end','medio','tipo','metodopago_id','token','id_culqi','monto','culqi_id'];
