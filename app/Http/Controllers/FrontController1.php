...
class FrontController extends Controller
{
    ...
    public function index() /* Método que se ejecuta al iniciar la aplicación */
    {
        ...
        ->where([['r.idrubro','=','2'],['p.type','=','serie']])->count();
            ...
            if (Auth()->user()->isFree()){
             ...
             if(Auth()->user()->slugplan=="defined"){ /* Determina si existe un usuario gratuito auntenticado*/
              ...
              return view('web.home',compact('planes','videos','articulos','mediorc','mediotm','medioda','rubros', 'eventos','cursosC','cursosA','cursosM','seriesA','seriesM','seriesC'));
              }else{
              ...
              /* Determina si el usuario es de rol gratuito */
                 ...
                 if($promo_id != 0){
                      ...
                      if($promo->estado == 1){
                        return view('web.suscribemepromo',compact('plan','promo','seriesA','seriesM','seriesC','cursosC','cursosA','cursosM'));
                      }else{
                        return redirect('/');
                      }
                    }
      ...
      return view('web.index',compact('planes','videos','articulos','mediorc','mediotm','medioda','rubros', 'eventos','cursosC','cursosA','cursosM','seriesA','seriesM','seriesC'));
    ...
    public function index1() /* Método que se ejecuta al iniciar la aplicación */
    {
      ...
      if (!\Auth::guest()) { /* Determina si existe un usuario auntenticado */
        ...
        /* Retorna la vista Home, para usuaris autenticados */
         return view('web.home',compact('planes','videos','articulos','mediorc','mediotm','medioda','rubros', 'eventos','cursos','cursosC','cursosA','cursosM','seriesA','seriesM','seriesC'));
      }
      /* Retorna la vista Index para cualquier visitante */
      return view('web.index',compact('planes','videos','articulos','mediorc','mediotm','medioda','rubros', 'eventos','cursos','cursosC','cursosA','cursosM','seriesA','seriesM','seriesC'));
      // return view('web.index',compact('videos','articulos'));
    }
    ...
    $categorias = Categoria::join('subcategoria as sc','categoria.idcategoria','=','sc.idcategoria')->join('posts as p','p.idsubcategoria','=','sc.idsubcategoria')->where([['p.type','=','video'],['categoria.idrubro','=','2']])
      ...
      if (!\Auth::guest()) { /* Determina si existe un usuario auntenticado */
        ...
        /* Retorna la vista Home, para usuaris autenticados */
         return view('web.home',compact('planes','videos','articulos','mediorc','mediotm','medioda','rubros', 'eventos','cursos','cursosC','cursosA','cursosM'));
      }
      /* Retorna la vista Index para cualquier visitante */
      return view('web.index',compact('planes','videos','articulos','mediorc','mediotm','medioda','rubros', 'eventos','cursos','cursosC','cursosA','cursosM'));
      // return view('web.index',compact('videos','articulos'));
    }
   ...
   public function index3() /* Método que se ejecuta al iniciar la aplicación */
    ...
    public function getPlanes()
    {
      ...
      if(!\Auth::guest()){ // Verifica usuario autenticado
        ...
        if($user->isFree()){ // Verifica si el usuario tiene suscripcion gratis
          return view('web.planes',compact('planes')); // Retorna vista de planes
        }
        ...
        //if($user->isPremium() ){ // Verifica si el usuario tiene suscripcion premium
          ...
          return redirect()->route('suscription'); // retorna la ruta de suscripcion premium
        }
        return redirect('/'); // Retorna a la vista principal

      }else{
        return view('web.planes',compact('planes')); // retorna la vista de planes
      }

    }
   
    
     public function getPlanes1()
    {
    ...
    $ip= $_SERVER['REMOTE_ADDR'];
      ...
      if(!\Auth::guest()){ // Verifica usuario autenticado
        $user = Auth()->user(); // Recupera el usuario autenticado
        if($user->isFree()){ // Verifica si el usuario tiene suscripcion gratis
          return view('web.planes',compact('planes','a','cursosC','cursosA','cursosM')); // Retorna vista de planes
        }
        if($user->isPremium() and $user->tarjeta_id==''){ 
        //if($user->isPremium() ){ // Verifica si el usuario tiene suscripcion premium
          if($user->suscriptorDeposito->currentDays() < 15){ // Verifica caducidad de la suscripcion
          ...
          return redirect()->route('suscription','a','cursosC','cursosA','cursosM'); // retorna la ruta de suscripcion premium
        }
        return redirect('/'); // Retorna a la vista principal

      }else{
        return view('web.planes1',compact('planes','a','cursosC','cursosA','cursosM')); // retorna la vista de planes
      }
       ...
       public function registrar($slug)
    {
      ...
      $cursosC=  Curso::where('estado','=','1')->where('expira','>',date('Y-m-d'))->where('rubro_id','=','2')->limit(3)->get();
        ...
        return view('auth.register1',compact('medios','a','slug','cursosC','cursosA','cursosM')); 
      ...
      if($plan->moneda=="PEN" AND $moneda=="PEN"){
          if ($currentUser->isFree()) {
            ...
            if($promo_id != 0){
              $promo = Promocion::find($promo_id);
              if($promo->estado == 1){
                return view('web.suscribemepromo',compact('plan','promo','cursosC','cursosA','cursosM'));
              }else{
                return redirect('/');
              }
            }
              /* Retorna la vista para pago */
              return view('web.suscribeme',compact('plan','cursosC','cursosA','cursosM'));
          }
...
*/
    ...
    public function getarticulos()
    {
      ...
      $cursosC=  Curso::where('estado','=','1')->where('expira','>',date('Y-m-d'))->where('rubro_id','=','2')->limit(3)->get();
        ...
        return view('web.articulos',compact('posts','rubros','cursosC','cursosM','cursosA'));
    }
      ...
      if (!\Auth::guest()) { // Verfica usuario autenticado
        ...
        if ($post->acceso == 1) {
          if (!Auth()->user()->isFree()) {
            ...
            return view('web.articulo',compact('post','categoria','relacionados','btnDisabled','btnDisabled2','cursosA','cursosC','cursosM'));
    ...
    public function articulosRubro($slug)
    {
      ...
      return view('web.articulosrubro',compact('rubro','categorias','posts','cursosC','cursosA','cursosM'));
    }
    //cambios 
     public function eventosRubro($slug)
    {
      ...
      return view('web.eventos', compact('active_events','inactive_events','rubros','cursosC','cursosA','cursosM'));
    }
    ...
    public function articulosCategoria($slug)
    {
      ...
      return view('web.articuloscategoria',compact('categoria','subcategorias','posts','cursosC','cursosA','cursosM'));
    }
    public function articulosSubCategoria($slug)
    {
      ...
      return view('web.articulossubcategoria',compact('categoria','subcategoria','posts','cursosC','cursosA','cursosM'));
    }
    public function articulosAutor($autor)
    {
      ...
      return view('web.articulosautor',compact('rubros','autor','posts','cursosC','cursosA','cursosM'));
    ...
    public function getvideos()
    {
      ...
      $cursosC=  Curso::where('estado','=','1')->where('expira','>',date('Y-m-d'))->where('rubro_id','=','2')->limit(3)->get();
        ...
        return view('web.videos',compact('posts','rubros','cursosC','cursosA','cursosM'));
    }
    ...
    public function videosRubro($slug)
    {
      ...
      return view('web.videosrubro',compact('rubro','categorias','posts','cursosC','cursosA','cursosM'));
    }
    public function videosCategoria($slug)
    {
      ...
      return view('web.videoscategoria',compact('categoria','subcategorias','posts','cursosC','cursosA','cursosM'));
    }
     ...
     public function videosSubCategoria($slug)
    {
      ...
      return view('web.videossubcategoria',compact('categoria','subcategoria','posts','cursosC','cursosA','cursosM'));
    }


    public function videosAutor($slug)
    {
      ...
      if ($autor) {
        return view('web.videosautor',compact('autor','cursosC','cursosA','cursosM')); 
      }
      return redirect('/');
      // dd($autor);      
      ...
      if (!\Auth::guest()) {
        ...
        if ($post->acceso == 1) {
          ...
          if (!Auth()->user()->isFree()) {
              ...
              /*  if(Auth()->user()->isCliente() AND Auth()->user()->cliente->Caducidad()==0)
                {
                   
                $posts = Post::all();
                return view('web.videopreview',compact('post','posts','cursosC','cursosA','cursosM'));
                }*/
            ...
            return view('web.video',compact('post','recents','btnDisabled','btnDisabled2','cursosC','cursosA','cursosM'));
    ...
    public function getrevistas($medio = 'RC')
    {
      ...
      $cursosC=  Curso::where('estado','=','1')->where('expira','>',date('Y-m-d'))->where('rubro_id','=','2')->limit(3)->get();
        ...
        return view('web.revistas',compact('revistas','medio','cursosC','cursosA','cursosM'));
    }
    ...
    public function getRevista($medio, $edicion)
    {
      ...
      $cursosC=  Curso::where('estado','=','1')->where('expira','>',date('Y-m-d'))->where('rubro_id','=','2')->limit(3)->get();
           ...
           return view('web.revista',compact('ruta','publicacion','cursosC','cursosA','cursosM'));
          }else{
    ...
    public function getsuplemento()
    {
      ...
      if (!\Auth::guest()) {
                if (Auth()->user()->isFree()) {
                  ...
                  return view('web.suplementoprev',compact('cursosC','cursosA','cursosM'));
                }
                ...
                return view('web.suplemento',compact('edicion','suplemento','ediciones','cursosC','cursosA','cursosM'));
    ...
    public function searchQuery(Request $request)
    {
      ...
      return view('web.results',compact('posts','texto','videos','cursosC','cursosM','cursosA'));
    }
...
//Cursos
       ...
       public function cursosRubro($slug)
    {
      ...
      $cursosC=  Curso::where('estado','=','1')->where('expira','>',date('Y-m-d'))->where('rubro_id','=','2')->limit(3)->get();
       ...
       return view('web.cursos', compact('cursos','slug','cursos1','cursosC','cursosA','cursosM','cursosP'));
    }
      ...
      public function beneficios()
    {
      ...
      if(Auth()->user()->susplan100r()>0 or Auth()->user()->susplan100d()>0){
        ...
        return view('web.beneficios', compact('cursosC','cursosA','cursosM'));
        }
        else{
...
if (Auth()->user()->susplan100r()>0 or Auth()->user()->susplan100d()>0) {
    ...
    if($curso->estado==1 and $curso->expira > date('Y-m-d') and Auth()->user()->countsusgratis()<1){
     ...
     if (Auth()->user()->SuscriptorCursos($curso->id)) {
        ...
        return view('web.beneficio', compact('curso','clases','rubro','slug','evaluacion','comentarios','temas','cursosC','cursosA','cursosM'));
    }
    else{
       return back()->with('');
    }
    ...
    public function getmiscursos(){
      ...
      return view('web.miscursos', compact('cursos','cursosC','cursosA','cursosM'));
     ...
     public function getmisintereses(){
      ...
      return view('web.misintereses', compact('cursos','cursosC','cursosA','cursosM'));
   ...
   public function getcurso($slug)
      ...
      $moneda="USD";
        ...
        if (!\Auth::guest()) {
          ...
          if (Auth()->user()->SuscriptorCursosG($curso->id)) {
            return view('web.curso1', compact('curso','clases','rubro','slug','evaluacion','comentarios','respuestas','materiales','temas','clase1','cursosC','cursosA','cursosM','sponsors_cursos','sponsors','sponsor_contacts','sponsor_materiales','moneda'));
         ...
         if (!\Auth::guest()) {
          ...
          if (Auth()->user()->SuscriptorCursos($curso->id)) {
           ...
           return view('web.curso', compact('curso','clases','rubro','slug','evaluacion','comentarios','temas','cursosC','cursosA','cursosM','moneda'));
        }
        else{
          return view('web.curso', compact('curso','clases','rubro','slug','evaluacion','comentarios','temas','cursosC','cursosA','cursosM','moneda'));
        }
    ...
    public function getevaluacion($slug){
      ...
      $cursosC=  Curso::where('estado','=','1')->where('expira','>',date('Y-m-d'))->where('rubro_id','=','2')->limit(3)->get();
       ...
       return view('web.evaluacion', compact('curso','evaluacion','cuestionario','respuestas','cursosC','cursosA','cursosM'));
      ...
      $cursosC=  Curso::where('estado','=','1')->where('expira','>',date('Y-m-d'))->where('rubro_id','=','2')->limit(3)->get();
       ...
       if (Auth()->user()->SuscriptorCursos($curso->id)) {
        ...
        return view('web.resulEval', compact('curso','evaluacion','cuestionario','respuestas','evaluacion','evaluacion_user','cursosC','cursosA','cursosM'));
       ...
       public function getclases($slug)
    {
      ...
      if (!\Auth::guest()) {
         if (Auth()->user()->SuscriptorCursosG($curso->id)) {
                   ...
                   return view('web.clases', compact('curso','clases','rubro','slug','cursosC','cursosA','cursosM'));
                 }
      }
      ...
      $clases=Clase::where('curso_id',$curso->id)->get();
          ...
          if (Auth()->user()->SuscriptorCursosG($curso->id)) {
                   if ($clase->video_codigo!="") {
                    ...
                    return view('web.clase', compact('curso','clase','rubro','slug','materiales','clases','cursosC','cursosA','cursosM'));
                    }
                    return view('web.clase1', compact('curso','clase','rubro','slug','materiales','clases','cursosC','cursosA','cursosM'));
