...
class SuscriptorYape extends Model
{
    protected $table = 'suscriptores_yape';
    protected $fillable = ['user_id', 'plan_id', 'curso_id', 'suscription_init', 'suscription_end', 'medio','telefono','dni','codigo_verification', 'tipo', 'metodopago_id', 'gestor_id'];
